...
@Service
@Transactional
public class GroupBillboardRepositoryServiceImpl implements GroupBillboardRepositoryService {
    ...
    public GroupBillboardRepositoryServiceImpl(GroupBillboardRepositoryDao groupBillboardRepositoryDao, BillboardRepositoryDao billboardRepositoryDao) {
